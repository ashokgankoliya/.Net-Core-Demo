    ...
    $.addFlex = function(t, p) {
        ...
        var g = {
            ...
            doSearch: function() {
                ...
                if (p.query.length >= 11 && p.qtype == "MAWBNumber") {
        ...
        if (p.usepager) {
            ...
            $(g.bDiv).after(g.pDiv);
            var html = ' <div class="pGroup"> <div class="pFirst pButton" id="btnpfirst"><span></span></div><div class="pPrev pButton" id="btnPrev"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">Page <input type="text" id="txtpcontrol" size="4" value="1" /> of <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton" id="btnNext"><span></span></div><div class="pLast pButton" id="btnpLast"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton" id="fgrdReload"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
            ...
            //add search button
            if (p.searchitems) {
                $('.pDiv2', g.pDiv).prepend("<div class='pGroup'> <div class='pSearch pButton' id='btnenablesearch'><span></span></div> </div>  <div class='btnseparator'></div>");
                ...
                $(g.sDiv).append("<div class='sDiv2'>Quick Search <input type='text' size='30'  name='q' class='qsbox' /><select name='qtype' hidden='hidden' style=>" + sopt + "</select> <input style='height:24px;margin-left: 192px;' type='button' value='Search' id='btnfgrdSearch' /><input style='height:24px' type='button' value='Clear' id='btnfgrdClear' /></div>");
