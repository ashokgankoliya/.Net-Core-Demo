    ...
    $.addFlex = function(t, p) {
        ...
        if (p.usepager) {
            ...
            if (p.searchitems) {
                ...
                $(g.sDiv).append("<div class='sDiv2'>Quick Search <input type='text' size='30' name='q' class='qsbox' /><select name='qtype'>" + sopt + "</select> <input style='height:24px' type='button' value='Search' /><input style='height:24px' type='button' value='Clear' /></div>");
