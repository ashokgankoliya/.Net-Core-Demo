...
<%--                <tr style="height: 13px;">
                ...
                <tr style="height: 13px;">
                    <td>
                        <input id="rdoExpenseReport" class="rbARReports" type="radio" style="margin-top: 8px;" name="SalesSummaryReports">
                        <label for="rdoExpenseReport">Expense Report</label>
                    </td>
                </tr>
                <tr style="height: 13px;">
                    <td>
                        <input id="rdoDailyPTDSalesPersonSalesReport" class="rbARReports" type="radio" style="margin-top: 8px;" name="SalesSummaryReports">
                        <label for="rdoDailyPTDSalesPersonSalesReport">Daily/Period to Date Sales Summary by Sales Person</label>
                    </td>
                </tr>
...
<%--<div id="DialogGrossProfitBouq" style="display: none;">
    <fieldset id="fsSaleSummary" style="font-size: 14px; font-weight: bold; height: 270px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        ...
        <table>
            ...
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
                    <label id="lblGrossProfitBouquetSalesPerson">Sales Person </label>
                </td>
                <td>
...
<div id="DialogExpenseReport" style="display: none;">
    <fieldset id="fsExpenseDateRange" style="font-size: 18px; font-weight: bold; height: 68px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        <legend style="background: white; margin-left: 2px;"></legend>
        <table>
            <tr>
                <td colspan="2">
                    <input type="text" id="txtExpenseFromDateHidden" style="width: 0; height: 0; top: -100px; position: absolute;" />
                </td>
            </tr>
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
                    <label id="lblExpenseFromDateHidden">From </label>
                </td>
                <td>
                    <input id="txtExpenseDateFrom" class="rbARReports" type="text" style="margin-top: 8px; width: 120px;" />
                </td>
            </tr>
            <tr id="trExpenseToDatelbl">
                <td colspan="2" id="tdExpenseToDatelblhdn">
                    <input type="text" id="txtExpenseToDateHidden" style="width: 0; height: 0; top: -100px; position: absolute;" />
                </td>
            </tr>
            <tr style="height: 33px;" id="trExpenseToDatetxt">
                <td style="padding-right: 10px;" id="tdExpenseToDatelbl">
                    <label id="lblExpenseToDate">To </label>
                </td>
                <td id="tdExpenseToDatetxt">
                    <input id="txtExpenseDateTo" class="rbARReports" type="text" style="margin-top: 8px; width: 120px;" />
                </td>
            </tr>
        </table>
    </fieldset>
...
<script type="text/javascript">
    ...
    $(document).ready(new function () {
        ...
        $("#txtSummarySalesPersonDateFrom").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
        ...
        $("#txtSummarySalesPersonDateTo").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
        ...
        $("#txtDailyPtdSalesReportDateFrom").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
        ...
        $("#txtDailyPtdSalesReportDateTo").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
    ...
    $("#DialogSalesSummaryReports").dialog({
        ...
        buttons: {
            Next: function () {
                ...
                else if (CheckedID == "rdoExpenseReport") {
                    $("#DialogExpenseReport").dialog("open");
                }
                else if (CheckedID == "rdoDailyPTDSalesPersonSalesReport") {
                    console.log("rdoDailyPTDSalesPersonSalesReport selected")
                    $("#DialogDailyPTDSalesPersonSalesReport").dialog("open");
                }
    ...
    $("#DialogExpenseReport").dialog({
        ...
        buttons: {
            Print: function () {
                ...
                ARSessionFromDt = $("#txtExpenseDateFrom").val();
                ARSessionToDt = $("#txtExpenseDateTo").val();
                if (ARSessionFromDt == "") {
                    $.MessageBox("Please select Date");
                    return false;
                }
                ...
                PrintExpenseReport(ARSessionFromDt, ARSessionToDt);
            },
            Close: function () {
                $(this).dialog("close");
            }
        ...
        open: function () {
            $("#txtExpenseDateFrom").blur();
            $(".ui-dialog-buttonpane button:contains('Print')").addClass('dialogbuttonstyle icon-save');
            $(".ui-dialog-buttonpane button:contains('Close')").addClass('dialogbuttonstyle icon-cancel');
        },
    });

    $("#DialogDailyPTDSalesPersonSalesReport").dialog({
        autoOpen: false,
        resizable: false,
        title: "Daily/Period to Date Sales by Sales Person",
        width: 300,
        height: 200,
        modal: true,
        buttons: {
            Print: function () {
                ...
                ARSessionFromDt = $("#txtDailyPtdSalesReportFrom").val();
                ARSessionToDt = $("#txtDailyPtdSalesReportDateTo").val();
                if (ARSessionFromDt == "") {
                    $.MessageBox("Please select Date");
                    return false;
                }
                ...
                PrintDailyPTDSalesPersonSalesReport(ARSessionFromDt, ARSessionToDt);
            },
            Close: function () {
                $(this).dialog("close");
            }
        ...
        open: function () {
            $("#txtDailyPtdSalesReportDateFrom").blur();
            $(".ui-dialog-buttonpane button:contains('Print')").addClass('dialogbuttonstyle icon-save');
            $(".ui-dialog-buttonpane button:contains('Close')").addClass('dialogbuttonstyle icon-cancel');
        },
    });
    ...
    function PrintExpenseReport(FromDate, ToDate) {

        $.ajax({
            type: "POST",
            url: 'BloomService.asmx/PrintExpenseReportToExcel',
            data: "{'FromDate':'" + FromDate + "','ToDate': '" + ToDate + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (output) {
    ...
    function PrintDailyPTDSalesbySalesperson(FromDate, ToDate) {

        var w = window.open('GeneratingPDF.html');

        $.ajax({
            type: "POST",
            url: 'BloomService.asmx/PrintDailyPTDSalesbySalesperson',
            data: "{'FromDate':'" + FromDate + "','ToDate': '" + ToDate  + "'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (output) {
