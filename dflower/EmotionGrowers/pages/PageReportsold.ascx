...
<div id="DialogSalesSummaryBySalesPerson" style="display: none;">
    <fieldset id="fsSalesSummarybySalesperson" style="font-size: 14px; font-weight: bold; height: 270px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        <legend style="background: white; margin-left: 2px;"></legend>
        <table>
            <tr>
                <td colspan="2">
            ...
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
                    <label id="lblSummarySalesPersonDateFrom">From </label>
                </td>
                <td>
                    <input id="txtSummarySalesPersonDateFrom" class="rbSPARReports" type="text" style="margin-top: 8px; width: 120px;" />
                </td>
            </tr>
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
                    <label id="lblSummarySalesPersonDateTo">To </label>
                </td>
                <td>
                    <input id="txtSummarySalesPersonDateTo" class="rbSPARReports" type="text" style="margin-top: 8px; width: 120px;" />
                </td>
            </tr>
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
...
<div id="DialogGrossProfit" style="display: none;">
    <fieldset id="fsSaleSummary" style="font-size: 14px; font-weight: bold; height: 270px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        ...
        <table>
            ...
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
                    <label id="lblSalesSummarySalesPerson">Sales Person </label>
                </td>
                <td>
